...
<div class="affixed">
	<h2>2. Docenten <small>Geef hieronder je cijfer</small></h2>
	<div class="row-fluid">
...
<?php foreach($tutors as $tutor): ?>
	...
	<div class="tutor media<?php if(count($courses)) foreach($courses as $course){ echo " course-".$course->id; } ?>">
	  ...
	  <a class="pull-right">
			<textarea tabindex="<?php echo $tabIndex+1; ?>" name="motivation[<?php echo $tutor->id; ?>]" placeholder="Motivatie, waarom dit cijfer. Zeker bij een 8 of hoger." row="4"><?php echo $vote->why; ?></textarea>
		</a>
	  <a class="pull-right">
...
<div id="save-confirm" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="Sluit" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">Uw stem is ontvangen</h3>
  </div>
  <div class="modal-body">
    <p>Uw stem is ontvangen. Mocht u deze nog willen uitbreiden/aanpassen dan kan dit nog tot de stemmen sluiten.</p>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Aanpassen</button>
